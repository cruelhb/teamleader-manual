...
아래 문서는 **가짜 내용**이라 상단에 "⚠️ 이 문서는 샘플입니다" 경고가 붙어 있습니다.
실제 내용으로 바꾸거나 삭제해야 합니다.
...
실제 내용이 완성된 문서는 `welfare/경조사-안내.md` 와
`guide/팀별-잔여-회식비-조회.md` 두 건입니다.
